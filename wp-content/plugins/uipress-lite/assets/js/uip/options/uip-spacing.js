  ...
  return {
    ...
    <div class="uip-flex uip-flex-column uip-row-gap-xs">
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.padding}}</span></div>
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.margin}}</span></div>
