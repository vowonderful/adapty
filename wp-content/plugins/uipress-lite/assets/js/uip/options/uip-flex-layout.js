      ...
      <div class="uip-flex uip-flex-column uip-row-gap-xs">
        ...
        <template v-if="options.type == 'stack'">
          ...
          <div class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.direction}}</span></div>
          ...
          <div class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.distribute}}</span></div>
          ...
          <div class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.place}}</span></div>
          ...
          <div class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.wrap}}</span></div>
        ...
        <template v-if="options.type == 'grid'">
          ...
          <div class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.responsive}}</span></div>
          ...
          <div class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.columns}}</span></div>
          ...
          <div v-if="!options.responsive"  class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.rows}}</span></div>
          ...
          <div v-if="!options.responsive" class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.columnWidth}}</span></div>
          ...
          <div v-if="options.responsive" class="uip-grid-col-1-3">
            ...
            <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.minimumColumnWidth}}</span></div>
        ...
        <div class="uip-grid-col-1-3">
          ...
          <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.gap}}</span></div>
