  ...
  return {
    ...
    <div class="uip-flex uip-flex-column uip-row-gap-s">
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.transform}}</span></div>
            ...
            <template v-slot:content>
              ...
              <div class="uip-padding-s uip-min-w-250 uip-flex uip-flex-column uip-gap-xs">
                ...
                <div class="uip-grid-col-1-3">
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.translate}} X</span></div>
                ...
                <!--translateY -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.translate}} Y</span></div>
                ...
                <!--ScaleX -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.scale}} X</span></div>
                ...
                <!--ScaleY -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.scale}} Y</span></div>
                ...
                <!--Rotate X -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.rotate}} X (°)</span></div>
                ...
                <!--Rotate Y -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.rotate}} Y (°)</span></div>
                ...
                <!--Rotate Z -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.rotate}} Z (°)</span></div>
                ...
                <!--Skew X -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.skew}} X (°)</span></div>
                ...
                <!--Skew Y -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.skew}} Y (°)</span></div>
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.filters}}</span></div>
            ...
            <template v-slot:content>
              ...
              <div class="uip-padding-s uip-min-w-300 uip-flex uip-flex-column uip-gap-xs">
                ...
                <div class="uip-grid-col-1-3 uip-w-300">
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.mixBlendMode}}</span></div>
                ...
                <!--grayscale -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.grayscale}}</span></div>
                ...
                <!--blur -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.blur}} (px)</span></div>
                ...
                <!--backdropBlur -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.backdropBlur}} (px)</span></div>
                ...
                <!--saturate -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.saturate}}</span></div>
                ...
                <!--contrast -->
                  ...
                  <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.contrast}}</span></div>
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.transitionType}}</span></div>
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.transitionTime}}</span></div>
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.transitionDelay}}</span></div>
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.cursor}}</span></div>
