...
export function moduleData() {
  return {
    ...
    template: `
      ...
      <div v-if="layoutFetched" class="uip-background-default uip-body-font uip-h-viewport uip-max-h-viewport uip-flex uip-text-normal uip-app-frame uip-border-box uip-builder-frame uip-flex uip-flex-column uip-w-100p" @contextmenu="showOptions($event)" @click="hideContextual($event)">
      
          <!-- Right click content items -->
          <div ref="contextualMenu" class="uip-border-rounder uip-shadow uip-border uip-position-fixed uip-background-default uip-z-index-9" v-if="ui.contextualMenu.display" :style="returnContextMenuStyle()">
          ...
          <div class="uip-flex uip-h-100p uip-flex-grow uip-overflow-hidden uip-position-relative">
            ...
            <!--Left panel -->
            <div class="uip-overflow-auto uip-scrollbar uip-border-right uip-app-frame uip-flex-no-shrink uip-w-300 uip-max-h-100p uip-background-default uip-z-index-1 uip-position-absolute uip-top-0 uip-bottom-0" 
                    ...
                    <template v-if="ui.sideBar.activeTab == 'layers'" >
                      <div class="uip-flex uip-flex-column uip-row-gap-xs">
                        ...
                        <div class="uip-flex uip-flex-center uip-flex-middle uip-flex-row">
                          <drop-down width="260" dropPos="right" triggerClass="uip-w-100p" class="uip-w-100p">
